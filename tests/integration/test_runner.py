...
def run_tests(test_level: str, specific_test: str = None, verbose: bool = False, 
              coverage: bool = False, markers: str = None):
...
Environment Variables:
  ...
  AZURE_TENANT_ID            - Azure AD tenant ID
    ...
    parser.add_argument(
        '--test', '-t',
        help='Specific test file to run (e.g., test_mock_server.py)'
    )
    ...
    parser.add_argument(
        '--markers', '-m',
        help='Run tests matching specific pytest markers'
    )
