...
class TestVersionMethodsMockServer:
    ...
    @pytest.mark.asyncio
    async def test_all_version_methods_parallel(self, mock_client: FOClient, performance_metrics):
...
class TestPerformanceMockServer:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_requests(self, mock_client: FOClient, performance_metrics):
    ...
    @pytest.mark.asyncio
    async def test_large_dataset_handling(self, mock_client: FOClient, performance_metrics):
