...
class TestKeyVaultCredentialProvider:
    ...
    async def test_get_credentials_success(self):
        ...
        with patch('d365fo_client.credential_sources.SecretClient') as mock_secret_client_class:
    ...
    async def test_get_credentials_with_client_secret_auth(self):
        ...
        with patch('d365fo_client.credential_sources.SecretClient') as mock_secret_client_class, \
             patch('d365fo_client.credential_sources.ClientSecretCredential') as mock_cred_class:
...
class TestCredentialManager:
    ...
    def test_get_cache_stats(self):
        ...
        self.manager._credential_cache["expired"] = CachedCredentials(
            ...
            expires_at=past_time, source_hash="hash1"
        )
        self.manager._credential_cache["active"] = CachedCredentials(
            client_id="test", client_secret="test", tenant_id="test",
            expires_at=future_time, source_hash="hash2"
        )
