...
class TestCompositeKeyHandling:
    ...
    def test_build_entity_url_composite_key(self):
        ...
        assert url == "https://example.com/data/CustomersV3(dataAreaId='usmf',CustomerAccount='MAFZAAL001')"
    ...
    def test_build_action_url_simple_key(self):
        ...
        assert url == "https://example.com/data/CustomersV3('CUST001')/Microsoft.Dynamics.DataEntities.TestAction"
    ...
    def test_build_action_url_composite_key(self):
        ...
        assert url == "https://example.com/data/CustomersV3(dataAreaId='usmf',CustomerAccount='MAFZAAL001')/Microsoft.Dynamics.DataEntities.TestAction"
    ...
    def test_build_action_url_entity_set_bound(self):
        ...
        assert url == "https://example.com/data/CustomersV3/Microsoft.Dynamics.DataEntities.TestAction"
    ...
    def test_build_action_url_unbound(self):
        ...
        assert url == "https://example.com/data/Microsoft.Dynamics.DataEntities.TestAction"
