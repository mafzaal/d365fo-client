...
def process_label_fallback(
    label_id: Optional[str], label_text: Optional[str]
) -> Optional[str]:
...
def process_enumeration_labels(enumeration: EnumerationInfo) -> EnumerationInfo:
    ...
    enumeration.label_text = process_label_fallback(
        enumeration.label_id, enumeration.label_text
    )
