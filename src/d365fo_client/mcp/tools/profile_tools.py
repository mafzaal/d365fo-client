...
class ProfileTools:
    ...
    async def execute_get_profile(self, arguments: dict) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=json.dumps(profile_dict, indent=2)
            )]
            
        except Exception as e:
            logger.error(f"Get profile failed: {e}")
            error_response = {"error": str(e), "tool": "d365fo_get_profile", "arguments": arguments}
            return [TextContent(type="text", text=json.dumps(error_response, indent=2))]
    ...
    async def execute_create_profile(self, arguments: dict) -> List[TextContent]:
        ...
        try:
            ...
            error_response = {"error": str(e), "tool": "d365fo_create_profile", "arguments": arguments}
            return [TextContent(type="text", text=json.dumps(error_response, indent=2))]
    ...
    async def execute_update_profile(self, arguments: dict) -> List[TextContent]:
        ...
        try:
            ...
            error_response = {"error": str(e), "tool": "d365fo_update_profile", "arguments": arguments}
            return [TextContent(type="text", text=json.dumps(error_response, indent=2))]
    ...
    async def execute_delete_profile(self, arguments: dict) -> List[TextContent]:
        ...
        try:
            ...
            error_response = {"error": str(e), "tool": "d365fo_delete_profile", "arguments": arguments}
            return [TextContent(type="text", text=json.dumps(error_response, indent=2))]
    ...
    async def execute_set_default_profile(self, arguments: dict) -> List[TextContent]:
        ...
        try:
            ...
            error_response = {"error": str(e), "tool": "d365fo_set_default_profile", "arguments": arguments}
            return [TextContent(type="text", text=json.dumps(error_response, indent=2))]
    ...
    async def execute_validate_profile(self, arguments: dict) -> List[TextContent]:
        ...
        try:
            ...
            response = {
                ...
                "message": "Profile is valid" if not validation_errors else "Profile has validation errors"
            }
            ...
            error_response = {"error": str(e), "tool": "d365fo_validate_profile", "arguments": arguments}
            return [TextContent(type="text", text=json.dumps(error_response, indent=2))]
    
    async def execute_test_profile_connection(self, arguments: dict) -> List[TextContent]:
        ...
        try:
            ...
            error_response = {"error": str(e), "tool": "d365fo_test_profile_connection", "arguments": arguments}
            return [TextContent(type="text", text=json.dumps(error_response, indent=2))]