        ...
        async with FOClient(config) as client:
            ...
            if hasattr(client.metadata_cache, 'get_label'):
                ...
                if retrieved == test_label_text:
                    ...
                    print(f"❌ Label retrieval failed: expected '{test_label_text}', got '{retrieved}'")
            
            print("\n5. Testing label operations through client...")
            try:
                # Try to get a common system label
                common_label = await client.get_label_text("@SYS1")  # Usually "OK" or similar
                if common_label:
            ...
            try:
                ...
                if result:
                    ...
                    if 'statistics' in stats:
                        ...
                        print(f"   Active labels: {label_stats.get('active_labels', 0)}")
            ...
            try:
                ...
                if 'label_cache' in cache_stats:
                    ...
                    print(f"   Total labels in cache: {label_cache.get('total_labels', 0)}")
