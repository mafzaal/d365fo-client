...
async def main():
    ...
    print(
        f"Effective profile for 'default': {effective_default.name if effective_default else 'None'}"
    )

    effective_none = pm.get_effective_profile(None)
    print(
        f"Effective profile for None: {effective_none.name if effective_none else 'None'}"
    )
