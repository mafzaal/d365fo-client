...
async def test_query_action():
    ...
    async with FOClient(config) as client:
        ...
        try:
            ...
            print(f"   Found {len(category_entities)} entities with category filter [0]")
        ...
        try:
            ...
            print(f"   Found {len(multi_category_entities)} entities with category filters [0, 1, 2]")
        ...
        try:
            ...
            if module_entities:
                for i, entity in enumerate(module_entities[:3]):
                    print(f"   - {entity.get('EntityName', 'N/A')} (Module: {entity.get('Module', 'N/A')})")
