...
async def test_mcp_server():
    ...
    # Test get profile
    result = await server.profile_tools.execute_get_profile(
...
def test_backward_compatibility():
    ...
    cli_profile = CLIProfile(name="legacy_test", base_url="https://legacy.example.com")
...
def test_migration_capabilities():
    ...
    print(
        f"   label_cache_expiry_minutes: {migrated_profile.label_cache_expiry_minutes}"
    )
