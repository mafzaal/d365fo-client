...
async def example_statistics_usage():
    ...
    print(
        f"  Navigation properties: {cache_stats.get('navigation_properties_count', 0)}"
    )
...
async def example_monitoring_function():
    ...
    async def monitor_metadata_cache(cache: MetadataCache) -> Dict[str, Any]:
        ...
        health_metrics = {"status": "healthy", "warnings": [], "metrics": {}}
        ...
        total_entities = stats.get("data_entities_count", 0) + stats.get(
