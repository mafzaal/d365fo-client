        ...
        async with FOClient(config) as client:
            ...
            if customer_list:
                ...
                if first_customer_account:
                    ...
                    customer_detail = await client.get_entity("Customers", first_customer_account)
    ...
    try:
        async with FOClient(config) as client:
            ...
            if entity_info:
                ...
                labeled_props = [p for p in entity_info.enhanced_properties if p.label_text]
                if labeled_props:
                    ...
                    for prop in labeled_props[:10]:  # Show first 10
                        ...
                        print(f"  {prop.name}: '{prop.label_text}'{key_indicator}{mandatory_indicator}")
            else:
...
async def main():
    ...
    print("=" * 60)
    print("IMPORTANT: Update the base_url in each example with your F&O environment URL")
    print("=" * 60)
