...
async def test_action_execution_mcp_tools():
    ...
    try:
        ...
        call_action_tool = next(
            (t for t in crud_tools if t.name == "d365fo_call_action"), None
        )
        ...
        bound_arguments = {
            ...
            "parameters": {"IncludeTax": True, "AsOfDate": "2024-01-15T00:00:00Z"},
        }
...
async def main():
    ...
    print(
        "- ✅ Support for all binding types (Unbound, BoundToEntitySet, BoundToEntity)"
    )
